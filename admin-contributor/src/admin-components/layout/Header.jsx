          ...
          <div className="flex-1 max-w-md mx-8">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 border border-slate-200 text-white rounded-xl 
                 bg-slate-800 placeholder-white focus:outline-none focus:ring-2 focus:ring-blue-500 
